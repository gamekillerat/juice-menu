...
namespace Big::UserInterface
{
	...
	public:
		...
		// Footer
		float m_FooterHeight = 0.001f;
		float m_FooterSpriteSize = 0.001f;
		Color m_FooterBackgroundColor{ 10, 10, 10, 0 };
		Color m_FooterSpriteColor{ 255, 255, 255, 0 };
