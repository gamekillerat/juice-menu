...
void Juice::Fre() {
	if (Fr) {
		...
		BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(player);
		BRAIN::CLEAR_PED_TASKS(player);
		BRAIN::CLEAR_PED_SECONDARY_TASK(player);
	}
}
...
bool Juice::DropArmorr = false;
void Juice::DropArmor()
{
	if (DropArmorr)
	{
...
bool Juice::DropParachutee = false;
void Juice::DropParachute()
{
	if (DropParachutee)
	{
		Ped selectedplayer = PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(g_SelectedPlayer);
...
bool Juice::DropSnackk = false;
void Juice::DropSnack()
{
	if (DropSnackk) {
		Ped selectedplayer = PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(g_SelectedPlayer);
		if (!ENTITY::DOES_ENTITY_EXIST(selectedplayer)) return;
...
int Juice::WaveIntensityValue = 0.f;
void Juice::SetWaveIntensity()
{
	WATER::_SET_CURRENT_INTENSITY(Juice::WaveIntensityValue);
}
bool Juice::savenewdrop331 = false;
void Juice::cashdrop331(){
	if (savenewdrop331){
		Ped iPed = PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(g_SelectedPlayer);
		STREAMING::REQUEST_MODEL(MISC::GET_HASH_KEY("a_c_dolphin"));
		if (!STREAMING::HAS_MODEL_LOADED(MISC::GET_HASH_KEY("a_c_dolphin"))) {
		SYSTEM::WAIT(0);}
		else {
			NativeVector3 playerPosition = ENTITY::GET_ENTITY_COORDS(iPed, FALSE);
			OBJECT::pockup(0x9CA6F755, playerPosition.x, playerPosition.y, playerPosition.z + 0.5f / 10, 0, 2000, MISC::GET_HASH_KEY("a_c_dolphin"), FALSE, TRUE);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(MISC::GET_HASH_KEY("a_c_dolphin"));
		}
	}
}
...
void Juice::KickFromVehiclee()
{
	if (KickFromVehicleebool) {
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(g_SelectedPlayer), FALSE))
		{
			...
			BRAIN::CLEAR_PED_TASKS(PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(g_SelectedPlayer));
			BRAIN::CLEAR_PED_SECONDARY_TASK(PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(g_SelectedPlayer));
		}
		else
		{  //ok thanks
			NULL;
...
void Juice::KickPlayerr(int player)
{
			DWORD64 args[2] = { -442306200, g_SelectedPlayer};
...
bool Juice::dowbool = false;
void Juice::DriveOnWater() {
	if (dowbool) {
		Player player = PLAYER::PLAYER_ID();
...
bool Juice::savenewdropcagee = false;
void Juice::cashdropcage()
{
	if (savenewdropcagee) {
		Ped iPed = PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(g_SelectedPlayer);
		STREAMING::REQUEST_MODEL(MISC::GET_HASH_KEY("prop_gold_cont_01"));
		if (!STREAMING::HAS_MODEL_LOADED(MISC::GET_HASH_KEY("prop_gold_cont_01"))) {
			SYSTEM::WAIT(0);
		}
		else {
			NativeVector3 playerPosition = ENTITY::GET_ENTITY_COORDS(iPed, FALSE);
			OBJECT::pockup(0xDE78F17E, playerPosition.x, playerPosition.y, playerPosition.z + 0.5f / 10, 10, 0, MISC::GET_HASH_KEY("prop_gold_cont_01"), FALSE, TRUE);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(MISC::GET_HASH_KEY("prop_gold_cont_01"));
		}
	}
}
bool Juice::fakkkbool = false;
void Juice::fakkk()
{
	if (fakkkbool) {
		Ped iPed = PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(g_SelectedPlayer);
		STREAMING::REQUEST_MODEL(MISC::GET_HASH_KEY("PROP_MONEY_BAG_01"));
		if (!STREAMING::HAS_MODEL_LOADED(MISC::GET_HASH_KEY("PROP_MONEY_BAG_01"))) {
			SYSTEM::WAIT(0);
		}
		else {
			NativeVector3 playerPosition = ENTITY::GET_ENTITY_COORDS(iPed, FALSE);
			OBJECT::pockup(0xDE78F17E, playerPosition.x, playerPosition.y, playerPosition.z + 1.10f / 10, 10, 0, MISC::GET_HASH_KEY("PROP_MONEY_BAG_01"), FALSE, TRUE);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(MISC::GET_HASH_KEY("PROP_MONEY_BAG_01"));
		}
	}
}
bool Juice::fakkkkbool = false;
void Juice::fakkkk()
{
	if (fakkkbool) {
		Ped iPed = PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(g_SelectedPlayer);
		STREAMING::REQUEST_MODEL(MISC::GET_HASH_KEY("DINGHY2"));
		if (!STREAMING::HAS_MODEL_LOADED(MISC::GET_HASH_KEY("DINGHY2"))) {
			SYSTEM::WAIT(0);
		}
		else {
			NativeVector3 playerPosition = ENTITY::GET_ENTITY_COORDS(iPed, FALSE);
			OBJECT::pockup(0xDE78F17E, playerPosition.x, playerPosition.y, playerPosition.z + 1.10f / 10, 10, 0, MISC::GET_HASH_KEY("DINGHY2"), FALSE, TRUE);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(MISC::GET_HASH_KEY("DINGHY2"));
		}
	}
}
...
int playerme = 0;
int amounttta = 6000000;
bool Juice::Cargoloopbool = false;
void Juice::Cargoloop()
{
	if (Cargoloopbool) {
		Any idk = MISC::GET_RANDOM_INT_IN_RANGE(1000000000, 2999999999);
		UNK3::_NETWORK_SHOP_BEGIN_SERVICE(&idk, 1474183246, 312105838, 1445302971, amounttta, 1);
		UNK3::_NETWORK_SHOP_CHECKOUT_START(idk);
		HUD::_SET_NOTIFICATION_TEXT_ENTRY("STRING");
		HUD::_SET_NOTIFICATION_TEXT_ENTRY((char*)"STRING");
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME("So Much Money");
		HUD::_SET_NOTIFICATION_MESSAGE_CLAN_TAG_2((char*)"Juice", (char*)"Juice", true, 5, (char*)"~p~Juice", (char*)"Cargo Loop Is On!", 1.f, (char*)"", 5, 0);
		HUD::_DRAW_NOTIFICATION(false, false);
	}
}
void ForceKick() {
...
bool Juice::savenewdrop1 = false;
void Juice::cashdrop1()
{
	...
	if (savenewdrop1) {
		...
		if (!STREAMING::HAS_MODEL_LOADED(MISC::GET_HASH_KEY("PROP_MONEY_BAG_01"))) {
			...
			NativeVector3 playerPosition = ENTITY::GET_ENTITY_COORDS(iPed, FALSE);
			OBJECT::pockup(0xDE78F17E, playerPosition.x, playerPosition.y, playerPosition.z + 0.5f / 10, 0, 2000, MISC::GET_HASH_KEY("PROP_MONEY_BAG_01"), FALSE, TRUE);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(MISC::GET_HASH_KEY("PROP_MONEY_BAG_01"));
		}
	}
}
...
bool Juice::savenewdrop5 = false;
void Juice::cashdrop5()
	{

		if (savenewdrop5) {
			Ped iPed = PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(g_SelectedPlayer);
			STREAMING::REQUEST_MODEL(MISC::GET_HASH_KEY("PROP_WEED_02"));
			if (!STREAMING::HAS_MODEL_LOADED(MISC::GET_HASH_KEY("PROP_WEED_02"))) {
				SYSTEM::WAIT(0);
			}
			else {
				NativeVector3 playerPosition = ENTITY::GET_ENTITY_COORDS(iPed, FALSE);
				OBJECT::pockup(0xDE78F17E, playerPosition.x, playerPosition.y, playerPosition.z + 0.5f / 10, 0, 2500, MISC::GET_HASH_KEY("PROP_WEED_02"), FALSE, TRUE);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(MISC::GET_HASH_KEY("PROP_WEED_02"));
			}
		}
	}
bool Juice::alldrop = false;
void Juice::AllDrop()
{ 
	if (alldrop)
	{
			for (int i = 0; i < 32; i++)
			{
				...
				if (excludeMe > 0 && excludeMe != PLAYER::PLAYER_PED_ID())
				{
					...
					if (!STREAMING::HAS_MODEL_LOADED(bagHash)) {
						...
						NativeVector3 playerPosition = ENTITY::GET_ENTITY_COORDS(iPed, FALSE);
						OBJECT::pockup(0xDE78F17E, playerPosition.x, playerPosition.y, playerPosition.z, TRUE, TRUE, TRUE, TRUE, TRUE);
...
bool Juice::expammo2 = false;
void Juice::Expammos2() {
	if (expammo2) {
		MISC::SET_EXPLOSIVE_AMMO_THIS_FRAME(playerme);
		PLAYER::SET_PLAYER_WEAPON_DAMAGE_MODIFIER(playerme, 1000000);
		NativeVector3 iCoord;
		int EXP_TAG_GRENADE = 0;
		if (WEAPON::GET_PED_LAST_WEAPON_IMPACT_COORD(PLAYER::PLAYER_PED_ID(), &iCoord)){
			iCoord.z += 15;
			MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(iCoord.x, iCoord.y, iCoord.z + 35, iCoord.x, iCoord.y, iCoord.z, 250, 1, MISC::GET_HASH_KEY("VEHICLE_WEAPON_SPACE_ROCKET"), PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(playerme), 1, 1, 500);
			...
			MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(iCoord.x, iCoord.y, iCoord.z + 55, iCoord.x, iCoord.y, iCoord.z, 100, false, 0xF8A3939F, PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(playerme), true, true, 600);
		}
	}
}
...
bool Juice::Timebool = false;
bool Juice::savenewdrop6 = false;
void Juice::cashdrop6()
{

	if (savenewdrop6){
		Ped iPed = PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(g_SelectedPlayer);
		STREAMING::REQUEST_MODEL(MISC::GET_HASH_KEY("prop_alien_egg_01"));
		if (!STREAMING::HAS_MODEL_LOADED(MISC::GET_HASH_KEY("prop_alien_egg_01"))) {
			SYSTEM::WAIT(0);
		}
		else {
			NativeVector3 playerPosition = ENTITY::GET_ENTITY_COORDS(iPed, FALSE);
			OBJECT::pockup(0xDE78F17E, playerPosition.x, playerPosition.y, playerPosition.z + 0.5f / 10, 0, 2000, MISC::GET_HASH_KEY("prop_alien_egg_01"), FALSE, TRUE);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(MISC::GET_HASH_KEY("prop_alien_egg_01"));
		}
	}
}
bool Juice::savenewdrop31 = false;
void Juice::cashdrop31()
{
	...
	if (savenewdrop31) 
	{
		...
		Ped iPed = PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(g_SelectedPlayer);
		STREAMING::REQUEST_MODEL(MISC::GET_HASH_KEY("prop_acc_guitar_01"));
		if (!STREAMING::HAS_MODEL_LOADED(MISC::GET_HASH_KEY("prop_acc_guitar_01"))) {
			SYSTEM::WAIT(0);
		}
		else {
			NativeVector3 playerPosition = ENTITY::GET_ENTITY_COORDS(iPed, FALSE);
			OBJECT::pockup(0xDE78F17E, playerPosition.x, playerPosition.y, playerPosition.z + 0.5f / 10, 0, 2000, MISC::GET_HASH_KEY("prop_acc_guitar_01"), FALSE, TRUE);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(MISC::GET_HASH_KEY("prop_acc_guitar_01"));
		}
	}
}
bool Juice::savenewdrop7 = false;
void Juice::cashdrop7()
{

	if (savenewdrop7){
        Ped iPed = PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(g_SelectedPlayer);
		STREAMING::REQUEST_MODEL(MISC::GET_HASH_KEY("prop_xmas_tree_int"));
		if (!STREAMING::HAS_MODEL_LOADED(MISC::GET_HASH_KEY("prop_xmas_tree_int"))) {
			SYSTEM::WAIT(0);
		}
		else {
			NativeVector3 playerPosition = ENTITY::GET_ENTITY_COORDS(iPed, FALSE);
			OBJECT::pockup(0xDE78F17E, playerPosition.x, playerPosition.y, playerPosition.z + 0.5f / 10, 0, 2000, MISC::GET_HASH_KEY("prop_xmas_tree_int"), FALSE, TRUE);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(MISC::GET_HASH_KEY("prop_xmas_tree_int"));
		}
	}
}
	...
	if (STREAMING::IS_MODEL_IN_CDIMAGE(vehiclehash) && STREAMING::IS_MODEL_A_VEHICLE(vehiclehash)) {
		g_CallbackScript->AddCallback<ModelCallback>(vehiclehash, [=] {
			...
			*(unsigned short*)g_GameVariables->ModelBypass = 0x9090; //Just dont touch these :3
			Vehicle lastVehicle = VEHICLE::CREATE_VEHICLE(vehiclehash, Coordinates.x + 5.500, Coordinates.y, Coordinates.z, PedDirection, 1, 1); //Thats just for calling the Vehicle.
...
void Juice::ParticlEE1()
{
	if (particlee1)
	{
		...
		{
			NativeVector3 WaypointPos = UI::GET_BLIP_COORDS(WaypointHandle);
			WaypointPos.z += 25.0f;
...
void Juice::fireworkk()
{
	if (Juice::firework)
	{
		...
		GRAPHICS::_START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE_2("proj_xmas_firework", PLAYER::PLAYER_PED_ID(), 0, 0, 0, 0, 0, 0, 0, 0.5f, 0, 0, 0);
		STREAMING::REQUEST_NAMED_PTFX_ASSET("proj_xmas_firework");// FX Attachment
		GRAPHICS::_USE_PARTICLE_FX_ASSET_NEXT_CALL("proj_xmas_firework");
		GRAPHICS::_START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE_2("proj_xmas_firework", PLAYER::PLAYER_PED_ID(), 0, 0, 0, 0, 0, 0, 28422, 0.5f, 0, 0, 0);
		STREAMING::REQUEST_NAMED_PTFX_ASSET("proj_xmas_firework");// FX Attachment
		GRAPHICS::_USE_PARTICLE_FX_ASSET_NEXT_CALL("proj_xmas_firework");
		GRAPHICS::_START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE_2("proj_xmas_firework", PLAYER::PLAYER_PED_ID(), 0, 0, 0, 0, 0, 0, 60309, 0.5f, 0, 0, 0);
		STREAMING::REQUEST_NAMED_PTFX_ASSET("proj_xmas_firework");// FX Attachment
		GRAPHICS::_USE_PARTICLE_FX_ASSET_NEXT_CALL("proj_xmas_firework");
		GRAPHICS::_START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE_2("proj_xmas_firework", PLAYER::PLAYER_PED_ID(), 0, 0, 0, 0, 0, 0, 31086, 0.6f, 0, 0, 0);
		STREAMING::REQUEST_NAMED_PTFX_ASSET("proj_xmas_firework");// FX Attachment
		GRAPHICS::_USE_PARTICLE_FX_ASSET_NEXT_CALL("proj_xmas_firework");
		GRAPHICS::_START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE_2("proj_xmas_firework", PLAYER::PLAYER_PED_ID(), 0, 0, 0, 0, 0, 0, 52301, 0.5f, 0, 0, 0);
		STREAMING::REQUEST_NAMED_PTFX_ASSET("proj_xmas_firework");// FX Attachment
		GRAPHICS::_USE_PARTICLE_FX_ASSET_NEXT_CALL("proj_xmas_firework");
		GRAPHICS::_START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE_2("proj_xmas_firework", PLAYER::PLAYER_PED_ID(), 0, 0, 0, 0, 0, 0, 14201, 0.6f, 0, 0, 0);
	}
}
...
void Juice::pi()
{
	if (pip)
	{
		STREAMING::REQUEST_NAMED_PTFX_ASSET("scr_rcbarry2");// FX Attachment
		GRAPHICS::_USE_PARTICLE_FX_ASSET_NEXT_CALL("scr_rcbarry2");
		GRAPHICS::_START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE_2("scr_clown_appears", PLAYER::PLAYER_PED_ID(), 0, 0, 0, 0, 0, 0, 28422, 99.1f, 0, 0, 0);
		STREAMING::REQUEST_NAMED_PTFX_ASSET("scr_rcbarry2");// FX Attachment
		GRAPHICS::_USE_PARTICLE_FX_ASSET_NEXT_CALL("scr_rcbarry2");
		GRAPHICS::_START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE_2("scr_clown_appears", PLAYER::PLAYER_PED_ID(), 0, 0, 0, 0, 0, 0, 60309, 99.1f, 0, 0, 0);
		STREAMING::REQUEST_NAMED_PTFX_ASSET("scr_rcbarry2");// FX Attachment
		GRAPHICS::_USE_PARTICLE_FX_ASSET_NEXT_CALL("scr_rcbarry2");
		GRAPHICS::_START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE_2("scr_clown_appears", PLAYER::PLAYER_PED_ID(), 0, 0, 0, 0, 0, 0, 31086, 100.2f, 0, 0, 0);
		STREAMING::REQUEST_NAMED_PTFX_ASSET("scr_rcbarry2");// FX Attachment
		GRAPHICS::_USE_PARTICLE_FX_ASSET_NEXT_CALL("scr_rcbarry2");
		GRAPHICS::_START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE_2("scr_clown_appears", PLAYER::PLAYER_PED_ID(), 0, 0, 0, 0, 0, 0, 52301, 99.1f, 0, 0, 0);
		STREAMING::REQUEST_NAMED_PTFX_ASSET("scr_rcbarry2");// FX Attachment
		GRAPHICS::_USE_PARTICLE_FX_ASSET_NEXT_CALL("scr_rcbarry2");
	}
}
...
void Juice::pi1()
{
	...
	{
		STREAMING::REQUEST_NAMED_PTFX_ASSET("proj_xmas_firework");// FX Attachment
		GRAPHICS::_USE_PARTICLE_FX_ASSET_NEXT_CALL("scr_firework_xmas_burst_rgw");
		GRAPHICS::_START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE_2("scr_firework_xmas_burst_rgw", PLAYER::PLAYER_PED_ID(), 0, 0, 0, 0, 0, 0, 28422, 99.1f, 0, 0, 0);
		STREAMING::REQUEST_NAMED_PTFX_ASSET("proj_xmas_firework");// FX Attachment
		GRAPHICS::_USE_PARTICLE_FX_ASSET_NEXT_CALL("scr_firework_xmas_burst_rgw");
		GRAPHICS::_START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE_2("scr_firework_xmas_burst_rgw", PLAYER::PLAYER_PED_ID(), 0, 0, 0, 0, 0, 0, 60309, 99.1f, 0, 0, 0);
		STREAMING::REQUEST_NAMED_PTFX_ASSET("proj_xmas_firework");// FX Attachment
		GRAPHICS::_USE_PARTICLE_FX_ASSET_NEXT_CALL("scr_firework_xmas_burst_rgw");
		GRAPHICS::_START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE_2("scr_clown_appears", PLAYER::PLAYER_PED_ID(), 0, 0, 0, 0, 0, 0, 31086, 100.2f, 0, 0, 0);
		STREAMING::REQUEST_NAMED_PTFX_ASSET("proj_xmas_firework");// FX Attachment
